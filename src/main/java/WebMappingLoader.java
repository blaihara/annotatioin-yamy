...
public class WebMappingLoader {
  public static void main(String[] args){
    try{
      String annotationClassName = "jp.sample.ano.SampleAnnotation";
      String packageName = "jp.sample";
      ...
      System.out.printf("%s,%s,%s,%s,%s", "package", "class", "method", "args", "mapping info");
      System.out.println("");
      my.printMethodAnnotationInfo(packageName, clazz);
  ...
  public void printMethodAnnotationInfo(Annotation annotation, String packageName, String className, String methodName, String argsTypes){
    ...
    System.out.printf("%s,%s,%s,(%s),%s", packageName, className, methodName, argsTypes, annotationValue);
    System.out.println("");
  }
